...
<head>
	...
	<style>
		body {
			margin: 0;
			padding: 0;
			/*F:\phpStudy\PHPTutorial\WWW\myBlog\application\common\view\tpl\img\daoxiang.jpg*/
			background:url("/static/common/images/background.jpg") no-repeat;
			background-size:100%;
...
<div id="js-alert-box" class="alert-box">
	...
	<div class="alert-body">
		...
		<div class="alert-concent">
			<p><a href="https://github.com/LucklyJack">看看我呗~</a></p>
			<p><a href="javascript:void(0)" onclick="javascript:history.back(-1);">返回上一页</a></p>
		</div>
		<a id="js-alert-btn" class="alert-btn" href="<?php echo($url);?>">走你~</a>
	</div>
	<div class="alert-footer clearfix">
		...
		<div class="alert-footer-text"><p>我变秃了，但也变强了~</p></div>
	</div>
</div>
...
<script type="text/javascript">
	...
	function clear(interval_id) {
		clearInterval(interval_id);
	}
</script>

<script>alertSet('<?php echo(strip_tags($msg));?>');</script>
