...
class Dictionary extends Migrator
{
     ...
     */
    public function up() {
        $table = $this->table('dictionary', ['engine' => 'InnoDB', 'comment' => '字典表']);
        $table->addColumn('name', 'string', array('limit' => 25, 'default' => '', 'null' => false, 'comment' => '显示名称'))
            ->addColumn('en_name', 'string', array('limit' => 25, 'default' => '', 'null' => false, 'comment' => '字段标示'))
            ->addColumn('value', 'string', array('limit' => 255, 'default' => '', 'null' => false, 'comment' => '值'))
            ...
            ->addColumn('group', 'string', array('limit' => 25, 'default' => 0, 'null' => false, 'comment' => '组别'))
